...
<link rel="canonical" href="https://www.queromeumcmv.com.br/flores-de-maio" />
        ...
        <meta property="og:image" content="https://www.queromeumcmv.com.br/Flores%20de%20Maio/fachada%20flores%20de%20maio%20%20.webp" />
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1 relative rounded-2xl overflow-hidden shadow-2xl border-4 border-white/10">
                <img 
                  src="/Flores de Maio/mapa da localização flores de maio.webp" 
