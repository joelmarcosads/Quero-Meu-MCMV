...
const FgtsMcmv = lazy(() => import('./pages/FgtsMcmv'));
const SubsidioMcmv = lazy(() => import('./pages/SubsidioMcmv'));
const RendaMcmv = lazy(() => import('./pages/RendaMcmv'));
const DocumentosMcmv = lazy(() => import('./pages/DocumentosMcmv'));
      ...
      <BrowserRouter>
        ...
        <Suspense fallback={<div className="min-h-screen flex items-center justify-center bg-slate-50"><div className="w-8 h-8 border-4 border-accent border-t-transparent rounded-full animate-spin"></div></div>}>
          <Routes>
            ...
            <Route path="/fgts-minha-casa-minha-vida" element={<FgtsMcmv />} />
            <Route path="/subsidio-minha-casa-minha-vida" element={<SubsidioMcmv />} />
            <Route path="/renda-minha-casa-minha-vida" element={<RendaMcmv />} />
            <Route path="/documentos-minha-casa-minha-vida" element={<DocumentosMcmv />} />
